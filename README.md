...
* **Semaforización Automática:** Procesamiento y cálculo de fechas de retención que clasifica los documentos en tiempo real como: *Conservar* (Verde), *En Revisión* (Ámbar) y *Para Depurar* (Rojo).
...
2. Dale clic al botón **"Base de datos"** para abrir *HeidiSQL*.
