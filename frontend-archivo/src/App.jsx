          ...
          <div className="flex h-screen bg-[#F8FAFC] overflow-hidden">
            ...
            <div className="flex-1 flex flex-col overflow-hidden relative">
              ...
              <main className="flex-1 overflow-y-auto p-4 sm:p-8">
                ...
                {currentScreen.name === 'nuevo-expediente' && <RegistrarExpediente setScreen={setCurrentScreen} triggerToast={triggerGlobalToast} />}
                ...
                {currentScreen.name === 'digitalizacion' && <DigitalizacionScreen setScreen={setCurrentScreen} triggerToast={triggerGlobalToast} />}
                {currentScreen.name === 'seguimiento' && <SeguimientoScreen setScreen={setCurrentScreen} />}
                {currentScreen.name === 'reportes' && <ReportesScreen setScreen={setCurrentScreen} />}
                {currentScreen.name === 'nueva-solicitud' && <RegistrarSolicitud setScreen={setCurrentScreen} triggerToast={triggerGlobalToast} />}
                {currentScreen.name === 'bandeja-solicitudes' && <BandejaSolicitudes triggerToast={triggerGlobalToast} />}
                {currentScreen.name === 'historial-caja' && <HistorialCaja setScreen={setCurrentScreen} />}
                {currentScreen.name === 'reporte-costos' && <ReporteCostos setScreen={setCurrentScreen} />}
              </main>
            </div>
          </div>
        </CajaProvider>
