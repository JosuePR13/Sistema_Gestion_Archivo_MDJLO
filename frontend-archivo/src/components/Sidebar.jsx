...
// ====================================================================
// CONFIGURACIÓN DE MENÚS Y RUTAS DEL SISTEMA DE GESTIÓN
// ====================================================================

export default function Sidebar({ currentScreen, setScreen }) {

    // Arreglo de rutas del módulo central de Gestión Documental
    const menuArchivo = [
    ...
    // Arreglo de rutas asignadas al procesamiento de Mesa de Partes
    ...
    // --- ENRUTADOR SEGURO DE INTERFAZ ---
    // Previene la pérdida de datos si el usuario está en medio de un llenado de formulario activo
    const navegarConSeguridad = (targetScreenName) => {
        ...
        // Dispara un evento global controlado si hay un formulario abierto
    ...
    // --- ESTRUCTURA DEL CONTENEDOR LATERAL ---
    return (
        <aside className="w-64 bg-white border-r border-slate-200 flex flex-col h-screen shadow-[4px_0_24px_rgba(0,0,0,0.02)] relative z-20">
            ...
            {/* Zona de Enlaces: Menu interactivo con scroll interno */}
            <div className="flex-1 overflow-y-auto py-6 px-4 space-y-7">
                ...
                <div>
                    ...
                    >
                        {/* IMPLEMENTADO: Mismo icono institucional del Dashboard */}
                        ...
                        <span className="text-[13px] tracking-wide font-semibold">Inicio</span>
                    </button>
                </div>
                ...
                {/* Categoría C: Control Financiero de Tasas */}
                <div>
                    <h3 className="px-4 text-[11px] font-extrabold text-slate-400 uppercase tracking-widest mb-3">
                        Caja y Reportes
                    </h3>
